        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-sm-6 item">
                <div class="card">
                    <div class="card-header p-0 position-relative border-0">
                        <a href="services.php">
                            <img class="d-block img-responsive" src="cyber2.jpg" alt="card-image">
                        </a>
                    </div>
                    <div class="card-body service-details">
                        <a href="services.php" class="service-heading">Cyber Crime Awarness</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 mt-sm-0 mt-4 pt-sm-0 pt-2">
                <div class="card">
                    <div class="card-header p-0 position-relative border-0">
                        <a href="services.php">
                            <img class="d-block img-responsive" src="bounty.jpg" alt="card-image">
                        </a>
                    </div>
                    <div class="card-body service-details">
                        <a href="services.php" class="service-heading">Bug Bounty</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 mt-lg-0 mt-4 pt-lg-0 pt-2">
                <div class="card">
                    <div class="card-header p-0 position-relative border-0">
                        <a href="services.php">
                            <img class="d-block img-responsive" src="deve2.jpg" alt="card-image">
                        </a>
                    </div>
                    <div class="card-body service-details">
                        <a href="services.php" class="service-heading">Mobile Apps & Web Design &Logo,Broucher Design</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 mt-lg-0 mt-4 pt-lg-0 pt-2">
                <div class="card">
                    ...
                    <div class="card-body service-details">
                        <a href="services.php" class="service-heading">Social Media & Strategy</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="about-single">
                    ...
                    <div class="about-content">
                        <h5 class="mb-3"><a href="about.php">Bug Bounty</a></h5>
                        <p>A bug bounty program is a deal offered by many websites, organizations and software developers by which individuals can receive recognition and compensation[1][2] 
                            for reporting bugs, especially those pertaining to security exploits and vulnerabilities.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mt-md-0 mt-3">
                <div class="about-single">
                    ...
                    <div class="about-content">
                        <h5 class="mb-3"><a href="about.php">cyber awareness</a></h5>
                        <p>.Cybercrime is a type of crime involving a computer or a computer network. The computer may have been used in committing the crime, or it may be the target.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mt-lg-0 mt-3">
                <div class="about-single">
                    ...
                    <div class="about-content">
                        <h5 class="mb-3"><a href="about.php">Digital Marketing</a></h5>
                        <p>Digital marketing is the component of marketing that uses the Internet and online-based digital technologies such as desktop computers,
            ...
            <div class="col-lg-4 col-md-6 mt-lg-5 mt-4">
                <div class="about-single">
                    ...
                    <div class="about-content">
                        <h5 class="mb-3"><a href="about.php">Responsive design</a></h5>
                        <p>an approach to web design aimed at allowing desktop webpages to be viewed in response to the size of the screen 
                            or web browser one is viewing withn
                            .</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mt-lg-5 mt-4">
                <div class="about-single">
                    ...
                    <div class="about-content">
                        <h5 class="mb-3"><a href="about.php">Clean design</a></h5>
