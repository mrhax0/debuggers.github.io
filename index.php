    ...
    <div class="container py-lg-5 py-md-4">
        <div class="py-lg-5 py-4">
            <div class="banner-info-grid">
                <h3 class="mb-4"><sup></sup>SECURE DATA IN YOURE FINGER .</h3>
                <p>WE ARE PROVIDING CYBER SECURITY AWARNESS,PRECUATIONS,BUG HUNTING WEBSITE DEVELOPMENT AND GOOD FRIENDSHIP</p>
                <a class="btn btn-secondary btn-style mt-5 me-2" href="#discover"> Discover Now </a>
                <a class="btn btn-style transparent-btn mt-5" href="about.php"> Get Started </a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container py-md-5 py-2">
        <div class="row w3l-row">
            <div class="col-lg-6 w3l-image pe-lg-5 mb-lg-0 mb-md-5 mb-4">
                <img src="arshid.jpg" alt="" class="img-fluid">
            </div>
            <div class="col-lg-6 w3l-about-info px-lg-4 align-center">
                <h6 class="w3l-title-small mb-1">About Us</h6>
                <h3 class="w3l-title-main mb-2">BEST IT SOLUTION COMPANY AND CYBER CRIME AWARNESS TEAM NEAR THE WORLD</h3>
                <p class="my-4 pe-lg-5">My name is Arshid  and I am Founder of “The Dbuggers’’We've created a cyberspace in social media. cyber security awareness and precautions and good friendship. its our new startup.(The Dbuggers) </p>
                <h5 class="w3l-subtitle"> We provide the best services for your
                    growing company</h5>
                <div class="w3l-btn">
                    <a href="about.php" class="btn btn-style btn-secondary mt-lg-5 mt-4 me-2">Read More </a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container py-lg-5 py-md-4 py-2">
        <div class="row align-items-center">
            <div class="col-lg-7 pe-lg-5 align-center">
                ...
                <p class="mt-3"> we are providing our own ideas.</p>
                <div class="row two-grids mt-5">
                    ...
                    <div class="col-sm-6 grids_info d-flex mt-sm-0 mt-4">
                        ...
                        <div class="detail ms-3">
                            ...
                            <p>we are creating our own ideas
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 grids_info d-flex mt-md-5 mt-4">
                        ...
                        <div class="detail ms-3">
                            ...
                            <p> DIGITAL Marketing
                                ,MARKET YOUR PRODUCTS AND COMPANY
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-5 mt-lg-0 mt-5 position-relative">
                <img src="phpimg.jpg" alt="" class="img-fluid">
            </div>
        </div>
    </div>
</section>
                ...
                <div id="owl-demo1" class="owl-carousel owl-theme">
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="test-img"><img src="athiramam.jpg" class="img-fluid" alt="client-img">

                            </div>
                            <div class="testimonial">
                                <blockquote>
                                    <q>
                                        Our company is ranking high and all credits to DEBUGGERS Overall, it's been a great experience and even more than that, it's fun to work with DEBUGGERS and the entire Digital Marketing team. DEBUGGERS has strategized for our company growth in a most ideal way and that made our company a leading brand in our field. We hope to take forward this association to a greater level. Thank you DEBUGGERS  </q>
                                ...
                                <div class="testi-des">
                                    ...
                                    <div class="peopl align-self">
                                        <h3>athira</h3>
                                        <p class="indentity">php developer</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="test-img"><img src="akshaysir.jpg" class="img-fluid" alt="client-img">

                            </div>
                            <div class="testimonial">
                                <blockquote>
                                    <q>Would highly recommend DEBUGGERS awarness for students. in Web Designing The Best quality company in eranakulam
                                        </q>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="test-img"><img src="" class="img-fluid" alt="client-img">
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header p-0 position-relative">
                            <a href="#blog-single" class="zoom d-block">
                                <img class="card-img-bottom d-block" src="bughunt.jpg"
                                    alt="Card image cap">
                            </a>
                            <div class="date">
                                <p>20 jul 2023</p>
                        ...
                        <div class="card-body blog-details">
                            ...
                            <a href="#blog-single" class="blog-desc">Get inspiration from the community or just start hunting. </a>
                        </div>
                        <div class="card-footer">
                            <div class="author align-items-center">
                                <a href="#author" class="post-author"> 
                                    <img src="arshii.jpg" alt="" class="img-fluid rounded-circle">
                                </a>
                                <ul class="blog-meta">
                                    <li>
                                        <span class="meta-value">by</span><a href="#author"> ARSHID</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 item mt-md-0 mt-5">
                    <div class="card">
                        <div class="card-header p-0 position-relative">
                            <a href="#blog-single" class="zoom d-block">
                                <img class="card-img-bottom d-block" src="cybercrime.jpg"
                                    alt="Card image cap">
                            </a>
                            <div class="date">
                                <p>20 Mar, 22</p>
                        ...
                        <div class="card-body blog-details">
                            <div class="price-review mb-1 align-items-center">
                                <p>CYBER CRIME AWARNESS</p>
                            </div>
                            <a href="#blog-single" class="blog-desc">“A data breach is about both privacy and security.</a>
                        </div>
                        <div class="card-footer">
                            <div class="author align-items-center">
                                <a href="#author" class="post-author"> 
                                    <img src="cybercrime2.jpg" alt="" class="img-fluid rounded-circle">
                                </a>
                                 <ul class="blog-meta">
                                    <li>
                                        <span class="meta-value">by</span><a href="#author"> mr_hax</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <div class="container py-5">
        <div class="d-lg-flex align-items-center justify-content-between">
            <div class="left-content-call">
                <span class="mb-2 text-italic">If you spend more on coffee than on IT security, you will be hacked. ...</span>
            ...
            <div class="right-content-call mt-lg-0 mt-4">
                <ul class="buttons">
                    <li class="phone-sec me-lg-4"><i class="fas fa-phone-volume"></i>
                        <a class="call-style-w3" href="tel:+917356198289">+91 7356198289</a>
                    </li>
                    <li><a href="contact.php" class="btn btn-style transparent-btn mt-lg-0 mt-3">Get Free Quote</a>
                    </li>
                </ul>
            </div>
        </div>
